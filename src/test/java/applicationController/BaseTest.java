...
public class BaseTest {
	...
	/**
	 * This will help to perform SendKeys operation for values reading from excel using JavaScript
	 */
	...
	public void waitForVisibilityByXpath(String locator) {
	...
	public boolean doubleClick(String locator) {
		...
		try {
			...
			log.info("Double clicked the " + locator);
			result = true;
		} catch (Exception e) {
	...
	public void getValueFromOptions(String xpath1, String value, String xpath2, String optionValue) {
		...
		try {
			...
			e.printStackTrace();
			log.info("Failed to select" + " " + optionValue + " " + "from the auto suggestions");
		}
	}
	...
	public boolean verifyTitle(String expectedTitle) {
		...
		try {
			if (actualTitle.equalsIgnoreCase(expectedTitle)) {
				...
				log.info("The title " + actualTitle + " does not match the actual title " + expectedTitle);
				result = false;
			}
		} catch (Exception e) {
			e.printStackTrace();
	...
	public boolean dropDownValue(String locator, String value) {
		...
		try {
			...
			e.printStackTrace();
			log.info("Failed to select" + " " + value + " " + "from the dropDown");
		}
		return result;
	}
	...
	/**
	 * This will help to perform File upload operation if Input tag is available in DOM
	 */
    ...
    public void uploadFile(String filePath) {
    	...
    	try {
    		...
    		//log.error("Failed to upload the file '"+filePath+"'");
    	    e.printStackTrace();
    	}
    }
